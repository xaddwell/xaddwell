...
- Data & Model Copyright: [ICME'26](https://nesa.zju.edu.cn/download/icme2026__camera.pdf), [KDD'26 Oral](https://arxiv.org/pdf/2507.07056), [ICML'26](https://openreview.net/forum?id=1BLni5Uxsd), [AAAI'27 Submission](), [Submission (Audio DeepFake Detection)](), [Submission (Prompt Copyright)]()
...
- *2026.08*: Our [PoisonLoRA](https://github.com/xaddwell/PoisonLoRA) was selected as the Best Poster at CCSC 2026!
...
# Publications
($^\star$ denotes equal contribution; first/co-first-author papers are listed first) / Full list in [Google Scholar](https://scholar.google.com/citations?user=Z7SkCL8AAAAJ)
...
- [LoRAShield: Data-Free Editing Alignment for Secure Personalized LoRA Sharing](https://arxiv.org/pdf/2507.07056), **Jiahao Chen**$^\star$, Junhao Li $^\star$, Yiming Wang, Yong Yang, Yi Jiang, Chunyi Zhou, Qingming Li, Tianyu Du, Shouling Ji, KDD 2026 Oral. [CCF-A] [Code](https://github.com/xaddwell/LoRAShield)
- [MADA-Attack: Transferable Multi-modal Attention Distraction Adversarial Attack against Vision Language Models](https://openreview.net/forum?id=ql0gSFEKAC), Zhihan Qin $^\star$, **Jiahao Chen**$^\star$, Chunyi Zhou, Yuwen Pu, Chunqiang Hu, Xiaolei Liu, Shouling Ji, ICML 2026. [CCF-A] [Code](https://github.com/RaymundoTheWolf/MADA-Attack)
...
- [Poison in the Well: Feature Embedding Disruption in Backdoor Attacks](https://arxiv.org/abs/2505.19821), Zhou Feng $^\star$, **Jiahao Chen** $^\star$, Chunyi Zhou, Yuwen Pu, Qingming Li, Shouling Ji, ICME 2025 Oral. [CCF-B]
- [Enhancing Adversarial Transferability with Adversarial Weight Tuning](https://ojs.aaai.org/index.php/AAAI/article/view/32203), **Jiahao Chen** $^\star$, Zhou Feng $^\star$, Rui Zeng, Yuwen Pu, Chunyi Zhou, Yi Jiang, Yuyou Gan, Jinbao Li, Shouling Ji, AAAI 2025. [CCF-A] [Code](https://github.com/xaddwell/AWT)
...
- [AEIOU: A Unified Defense Framework against NSFW Prompts in Text-to-Image Models](https://arxiv.org/abs/2412.18123), Yiming Wang, **Jiahao Chen**, Qingming Li, Tong Zhang, Rui Zeng, Xing Yang, Shouling Ji, TDSC 2026. [CCF-A]
...
- [The Eminence in Shadow: Exploiting Feature Boundary Ambiguity for Robust Backdoor Attacks](https://arxiv.org/abs/2512.10402), Zhou Feng, **Jiahao Chen**, Chunyi Zhou, Yuwen Pu, Tianyu Du, Jinbao Li, Jianhai Chen, Shouling Ji, KDD 2026. [CCF-A] [Code](https://github.com/NoobCodeNameless/Eminence)
- [Order within Chaos: Capturing Intrinsic Energy Anomalies for AI-Manipulated Image Forgery Localization](https://openreview.net/forum?id=1BLni5Uxsd), Yiming Wang, Baiqi Wu, Qingming Li, **Jiahao Chen**, Tong Zhang, Shouling Ji, ICML 2026. [CCF-A] [Code](https://github.com/phoenixnir/FLAME)
- [SOPE: Situation-Aware and Statistically Indistinguishable Privacy Exfiltration for MCP-enabled Agents](https://openreview.net/forum?id=Ra0pui9HXF), Ruixiao Lin, Qingming Li, **Jiahao Chen**, Chunyi Zhou, Shouling Ji, ICML 2026. [CCF-A]
- [Angel or Demon: Investigating the Plasticity Interventions' Impact on Backdoor Threats in Deep Reinforcement Learning](https://arxiv.org/abs/2605.14587), Oubo Ma, Ruixiao Lin, Yang Dai, **Jiahao Chen**, Chunyi Zhou, Linkang Du, Shouling Ji, ICML 2026. [CCF-A] [Code](https://github.com/maoubo/Plasticity)
- [LoRA-Hash: Unveiling Model Identity from Heavy-Tailed Weight Distributions](https://nesa.zju.edu.cn/download/icme2026__camera.pdf), Xing He, **Jiahao Chen**, Junhao Li, Feng Zhou, Shouling Ji, ICME 2026. [CCF-B]
...
- [Auditing M-LLMs for Privacy Risks: A Synthetic Benchmark and Evaluation Framework](https://link.springer.com/chapter/10.1007/978-981-95-6957-1_3), Junhao Li, **Jiahao Chen**, Zhou Feng, Chunyi Zhou, MMM 2026. [CCF-C] [Code](https://github.com/xaddwell/multimodal-privacy)
...
- [Enkidu: Universal Frequential Perturbation for Real-Time Audio Privacy Protection against Voice Deepfakes](https://dl.acm.org/doi/abs/10.1145/3746027.3755629), Zhou Feng, **Jiahao Chen**, Chunyi Zhou, Yuwen Pu, Qingming Li, Tianyu Du, Shouling Ji, MM 2025. [CCF-A] [Code](https://github.com/NoobCodeNameless/Enkidu)
